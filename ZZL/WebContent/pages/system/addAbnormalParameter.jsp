                    ...
                    <div class="col-md-12">
                        <div class="box box-primary">
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <!-- form start -->
                                    <form role="form" method="post" action="<%=request.getContextPath()%>/System/addAbnormalParameter">
                                        <div class="row">
                                        
                                            <div class="col-md-6">
                                                <div class="box-body">
                                                    <label>异常参数名称</label>
                                                    <input type="text" class="form-control" id="abParaName" name="abParaName">
                                                </div>
                                                <div class="box-body">
                                                    <label>异常参数边界</label>
                                                    <input type="text" class="form-control" id="abParaValue" name="abParaValue">
                                                </div>
                                                <div class="box-body">
