    ...
    <div class="wrapper row-offcanvas row-offcanvas-left">
        ...
        <aside class="right-side">
            ...
            <section class="content">            	
            	<div class="row">
                    <div class="col-md-12">
                    <form role="form" method="post" action="<%=request.getContextPath()%>/System/addUser">
                                ...
                                <div class="col-md-8">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="box-body">
                                                    <label>手机号码</label>
                                                    <input type="text" class="form-control" id="userMobileNum" name="userMobileNum">
                                                </div>
                                                <div class="box-body">
                                                    <label>微信号</label>
                                                    <input type="text" class="form-control" id="userWeChatNum" name="userWeChatNum">
                                                </div>
                                                <div class="box-body">
                                                    <label>备注</label>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="box-body">
                                                    <label>公司名称</label>
                                                    <input type="text" class="form-control" id="userComName" name="userComName">
                                                </div>
                                            </div>
                                ...
                                <div class="col-md-8">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="box-body">
                                                    <label>账户自编码</label>
                                                    <input type="text" readonly="readonly" class="form-control" id="userId" name="userId">
                                                </div>
